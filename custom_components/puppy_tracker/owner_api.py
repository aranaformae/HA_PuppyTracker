...
@websocket_api.websocket_command({
    ...
    vol.Optional("payment_amount"): vol.Any(str, None),
    vol.Optional("payment_method"): str,
    vol.Optional("payment_balance"): vol.Any(str, None),
    vol.Optional("contact_preference"): str,
})
