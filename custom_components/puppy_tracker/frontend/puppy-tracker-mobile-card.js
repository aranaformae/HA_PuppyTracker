...
class PuppyTrackerMobileCard extends HTMLElement {
  ...
  static getStubConfig() {
    return { title: "", tab: "weighing", show_weighing: true, show_quick_log: true, show_today: true, show_care_today: true, show_today_only: false, default_selected: "litter", puppy_id: "" };
  }
  ...
  static getConfigForm() {
    return { schema: [
      ...
      { name: "show_care_today", selector: { boolean: {} } },
  ...
  setConfig(config) {
    ...
    if (["weighing", "quickLog", "today", "care"].includes(config.tab)) this._tab = config.tab;
    this._render();
  }
  ...
  _availableTabs() {
    return [
      ...
      this._config.show_care_today !== false && "care",
    ].filter(Boolean);
  }
  ...
  _childForTab() {
    ...
    if (this._tab === "care") return "puppy-tracker-care-execution-card";
  ...
  _childConfig(tag) {
    ...
    if (tag === "puppy-tracker-care-execution-card") return {
      title: text(this, "careToday"),
      show_litter_selector: true,
  ...
  _updateTabChrome() {
    ...
    const hintKey = this._tab === "quickLog" ? "quickLogHint" : this._tab === "today" || this._tab === "care" ? "todayHint" : "weighingHint";
    const hint = this.shadowRoot?.querySelector(".hint");
    if (hint) hint.textContent = text(this, hintKey);
  }
  ...
  _renderChild() {
    ...
    surface.innerHTML = `<${childTag}></${childTag}>`;
    const child = surface.querySelector(childTag);
