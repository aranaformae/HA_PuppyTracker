...
class PuppyTrackerWorkspaceCard extends HTMLElement {
  ...
  _surfaceConfig(key) {
    ...
    const configs = {
      ...
      puppies: { show_litter_selector: showLitter },
      weighing: { show_litter_selector: showLitter, show_puppies: true, show_details: true },
      analysis: { show_litter_selector: showLitter },
