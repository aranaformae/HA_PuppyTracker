...
The Care preset of `custom:puppy-tracker-workspace-card` contains the dedicated
daily execution workflow. It lists open occurrences and records `completed` or
